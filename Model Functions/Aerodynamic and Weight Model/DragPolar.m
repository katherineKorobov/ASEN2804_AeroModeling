...
if Plot_DragPolar_Data == 1
    ...
    for n=1:Count
        ...
        plot(WingLiftCurve{n,:},WingDragCurve{1,:},'--');
        plot(WingLiftCurve{n,:},DragPolar_mod1{1,:});
        plot(WingLiftCurve{n,:},DragPolar_mod2{1,:});
        plot(WingLiftCurve{n,:},DragPolar_mod3{1,:});
