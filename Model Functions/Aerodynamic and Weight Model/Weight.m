...
% /////////////////////////////////////////////////////////////////////////
    ...
    W_empty(n)=W_f(n)+W_w(n)+W_h1(n)+W_h2(n)+W_v1(n)+W_v2(n)+W_bottle(n)+W_pay(n)+W_ballast(n);
    CG_empty(n)=(W_f(n)*CG_f(n)+W_w(n)*CG_w(n)+W_h1(n)*CG_h1(n)+W_h2(n)*CG_h2(n)+W_v1(n)*CG_v1(n)+W_v2(n)*CG_v2(n)+W_bottle(n)*CG_bottle(n)+W_pay(n)*CG_pay(n)+W_ballast(n)*CG_ballast(n))/W_empty(n);
